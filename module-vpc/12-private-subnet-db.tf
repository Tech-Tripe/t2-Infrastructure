...
#============================
resource "aws_subnet" "t2_private_subnet_db" {
    ...
    tags = {
        Name = "${var.environment}-private-subnet-db-${count.index + 1}-${data.aws_availability_zones.available.us-east-1[count.index]}"
